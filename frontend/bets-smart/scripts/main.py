...
insights_agent = ConversableAgent(
    name="Insights Agent",
    system_message="You are an insights agent. You analyze historical betting data and provide recommendations to improve betting performance. The user mainly bets on football matches, places bets only on the outcome of the match, bets amount under 25 dollars, and takes odds above 2.15, mainly bets to make the game more interesting. ",
